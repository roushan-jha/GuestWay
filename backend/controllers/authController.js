...
exports.login = catchAsync(async (req, res, next) => {
    ...
    if(!user || !(await user.isPasswordCorrect(password, user.password))) {
        return next(new AppError("Please check your email and password again!"), 401);
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    ...
    try {
        ...
        return next(new AppError('There was an error sending the eamil, Try again later!'), 500)
    }
});
